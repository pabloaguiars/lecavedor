...
<?php 
	 ...
	 $registroProducto = mysqli_query($con, "select * from productos where id = '$_REQUEST[v]'") or die(mysqli_error($con));
	 $registroCarrito = mysqli_query($con, "select * from carrito where id_producto = '$_REQUEST[v]'") or die(mysqli_error($con));
?>
<div id="wrapper">
<?php include('menu.php'); ?>
	...
	<div id="banner">
		...
		$precioFinal= $regProducto['precio']-$descuento;
		
		echo $regProducto['nombre']." ".$regProducto['marca']." "."		Cantidad:<br>";
