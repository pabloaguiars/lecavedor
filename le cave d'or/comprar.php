...
<?php include('menu.php'); ?>
	...
	<div id="banner">
		...
		<input type="hidden" name="producto" value="<?php echo $_REQUEST['productoElegido']; ?>">
		<input type="hidden" name="cantidad" value="<?php echo $_REQUEST['cantidad']; ?>">
		
		<form method="post"  action="comprar2.php">
		
		<span class="byline">¡Si cuenta con un Código Le Cave ingréseselo aquí para obtener 40% de descuento!: </span><input type="text" name="descuento" placeholder="" size="6"><br><br>
		
		
		<span class="byline">Seleccione el método de pago de su preferencia: </span><br><br>
		<span class="byline">Tarjeta de Crédito/Débito: </span><input type="radio" name="pago" value="tarjeta"><br>
		<span class="byline">Paypal: </span><input type="radio" name="pago" value="paypal"> <br>
